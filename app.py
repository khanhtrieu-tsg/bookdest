...
params = urllib.parse.quote_plus(
    "DRIVER={ODBC Driver 17 for SQL Server};SERVER=bookingserver.database.windows.net;DATABASE=bookdata;UID=bookadmin;PWD=123456aA@")
cnxn = pyodbc.connect(
    "Driver={ODBC Driver 17 for SQL Server};Server=bookingserver.database.windows.net,1433;Database=bookdata;Uid=bookadmin;Pwd=123456aA@;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;")
